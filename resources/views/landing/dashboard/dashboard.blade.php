        ...
        <div class="dashboard">
            ...
            <div class="statistik">
                <div class="head">
                    ...
                    <button class="date" data-bs-target="#calendarModal" data-bs-toggle="modal"> 
                    <!-- <button class="date" id="datepickerBtn" type="button"> -->
                    ...
                    <!-- <input type="text" id="datepickerInput" class="form-control" style="display:none;" value="02-16-2025"> -->
                    ...
                    <!-- <div class="modal fade" id="customModal" tabindex="-1" aria-labelledby="customModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            ...
                            <div class="modal-header">
                                <h5 class="modal-title" id="customModalLabel">Pilih Tanggal</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Tutup"></button>
                            </div>
                            <div class="modal-body">
                                <input type="text" id="datepickerInput" class="form-control">
                                <div id="popupDalamModal" style="display: none; border: 1px solid #ccc; padding: 15px; margin-top: 10px; background-color: #f9f9f9;">
                                Ini adalah pop-up di dalam modal!
            ...
            <div class="daftar-history">
                <div class="head">
                    ...
                    <div class="filter-bulan" >
                        <!-- <h6>Filter by Bulan</h6> -->
                        <input id="bulan" type="month" class="form-control form-control-sm" placeholder="Pilih Bulan dan Tahun">
                    </div>
                </div>
                <div class="history">
...
@include('landing.components.modal.filter-tanggal')
@section('script')
<script>
$(document).ready(function() {
    // Inisialisasi datepicker di input tersembunyi
    ...
    $('#datepickerBtn').on('click', function() {
        // Panggil datepicker dari input yang hidden
        $('#datepickerInput').datepicker('show');
    });

    // Ambil nilai tanggal saat dipilih
    $('#datepickerInput').on('changeDate', function(e) {
        var selectedDate = $('#datepickerInput').datepicker('getFormattedDate');
        console.log('Tanggal yang dipilih:', selectedDate);
        
        // Optional: kamu bisa ganti teks tombol sesuai tanggal yang dipilih
        $('#datepickerBtn h6').text(selectedDate);
    });
});

// $(document).ready(function() {
//     // Inisialisasi datepicker di input modal
//     $('#datepickerInput').datepicker({
//         format: 'mm-dd-yyyy',
//         autoclose: true,
//         todayHighlight: true
